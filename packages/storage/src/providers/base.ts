...
export abstract class BaseStorageProvider implements StorageProvider {
  ...
  abstract uploadBuffer(key: string, buffer: Buffer, mimeType?: string): Promise<void>;
  
  abstract uploadFile(key: string, filePath: string, mimeType?: string): Promise<void>;
  ...
  abstract listObjects(options?: ListObjectsOptions): Promise<ListObjectsResponse>;
