...
>(({ className, ...props }, ref) => {
  return (
    <RadioGroupPrimitive.Item
      ...
      {...props}
    >
      <RadioGroupPrimitive.Indicator className={cn('items-center justify-center h-full w-full')}>
        <Circle size={10} strokeWidth={0} fill="currentColor" className="text-primary" />
