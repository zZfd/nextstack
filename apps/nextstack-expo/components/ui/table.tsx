...
>(({ className, ...props }, ref) => (
  <TablePrimitive.Header ref={ref} className={cn('[&_tr]:border-b', className)} {...props} />
));
...
>(({ className, ...props }, ref) => (
  <TablePrimitive.Body ref={ref} className={cn('[&_tr:last-child]:border-0', className)} {...props} />
));
...
>(({ className, ...props }, ref) => (
  <TablePrimitive.Row
    ref={ref}
    className={cn('border-b transition-colors web:hover:bg-muted/50 web:data-[state=selected]:bg-muted', className)}
    {...props}
  />
));
...
>(({ className, ...props }, ref) => (
  <TextClassContext.Provider value={cn('font-medium text-muted-foreground', className)}>
    <TablePrimitive.Head
      ref={ref}
